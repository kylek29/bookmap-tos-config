...
**SPECIAL NOTE**: Bookmap will replace the lastUsed config in the settings file with the last set of settings you change in the program. If you have a set of settings you want to persist permanently, you may want to run this utility periodically or before you launch ToS.
